...
.\VBoxManage unattended install "$name" --iso="E:\Downloads\Parrot-kde-security-4.7_x64.iso" --user=john --password=johan007 --full-user-name="Tips For IT Pros" --time-zone=UTC --hostname=$name.lab.local
